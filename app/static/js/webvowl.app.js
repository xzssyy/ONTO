    ...
    /******/ ({
        ...
        /***/ (function (module, exports, __webpack_require__) {
            ...
            (function (d3) {
                ...
                module.exports = function () {
                    ...
                    //app.afterInitializationCallback=document.getElementById("mybtn").click();
                    ...
                    function adjustSliderSize() {
                        ...
                        // assuming DOM elements are generated in the block.html
                ...
                module.exports = function (graph) {
                    ...
                    exportMenu.exportAsUrl = function () {
                        ...
                        if (optsString.length === 0) {
                            // building up parameter recommend;
                    ...
                    function inlineVowlStyles() {
                        ...
                        setStyleSensitively(".white, .subclass, .subclassproperty, .external + text", [{
                            name: "fill",
                            value: "#fff"
                        }]);
        ...
        /***/ (function (module, exports, __webpack_require__) {
            ...
            (function (d3) {
                 ...
                 *
                 * @param graph the associated webOWL graph
                 * @returns {{}}
                 */
                module.exports = function (graph) {
                ...
                module.exports = function (graph) {
                    ...
                    searchMenu.setup = function () {
                        ...
                        mybtn.onclick = function () {
                            graph.mylocateSearchResult(target_id);
                        }
        ...
        /***/ (function (module, exports, __webpack_require__) {
            ...
            (function (d3) {
                module.exports = function (graph) {
                    ...
                    var DEFAULT_JSON_NAME = ontology_json_name; // This file is loaded by default
                    ...
                    function loadPresetOntology(ontology) {
                        ...
                        if (ontologyMenu.cachedOntology(ontology)) {
                            ...
                            var fileToRead = "./data?filename=" + ontology + ".json&ontology_id=" + ontology_id.toString();
                            if (f2r) {
                                fileToRead = f2r;
                            ...
                            // 加上用户名
                            d3.xhr(fileToRead, "application/json", function (error, request) { // 向后台请求本体文件
                                var loadingSuccessful = !error;
                                if (loadingSuccessful) {
        ...
        /***/ (function (module, exports, __webpack_require__) {
            ...
            (function (d3) {
                module.exports = function (graph) {
                    ...
                    // helper for standalone webOWL in chrome
